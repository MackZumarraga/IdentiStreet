...
l1 = Listing.create!(
    user_id: u1.id,
    address: "160 W 82nd St, New York, NY 10024",
    area: "Manhattan",
...
l2 = Listing.create!(
    user_id: u1.id,
    address: "247 Grand St, Brooklyn, NY 11211",
    area: "Brooklyn",
...
l3 = Listing.create!(
    user_id: u2.id,
    address: "5-13 50th Ave, Long Island City, NY 11101",
    area: "Queens",
...
l4 = Listing.create!(
    user_id: u2.id,
    address: "198 Hicks St, Brooklyn, NY 11201",
    area: "Brooklyn",
